...
public class DataItem {
  ...
  /**
   * Creates a new DataItem based on the given <code>item</code>. The underlying data is copied.
   *
  ...
  /**
   * Returns a the data of this item as a ByteBuffer. Modifications to the returned ByteBuffer will
   * be written back to this DataItem.
   *
  ...
  /**
   * Returns the backing <code>ByteBuffer</code> of this <code>DataItem</code>. This includes the
   * complete item with type, version and data bytes.
   *
