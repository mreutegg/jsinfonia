...
public abstract class ThriftClient<C> implements Closeable {
  ...
  public ThriftClient(String host, int port, int numConnections, boolean framed) throws TException {
  ...
  protected <T, E extends Throwable> T executeWithClient(final ClientCallable<T, C, E> callable)
      throws E {
    checkOpen();
    C c = null;
    while (c == null) {
